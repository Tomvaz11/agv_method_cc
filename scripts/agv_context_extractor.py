...
def main():
    ...
    blueprint_path = os.getenv('BLUEPRINT_PATH', 'PROJETO/Output_BluePrint_Arquitetural_Tocrisna_v1.0_ORIGINAL.md')
    order_path = os.getenv('ORDER_PATH', 'PROJETO/Output_Ordem_Para_Implementacao_Geral_v1.0_ORIGINAL.md')
